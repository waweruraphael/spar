   ...
   <div class="container">
     <div class="row mb-5">
       <div class="col-md">
         <div class="ftco-footer-widget mb-4">
           <h2 class="ftco-heading-2 logo">Salon System</h2>
           <?php
       ...
       <div class="col-md">
         <div class="ftco-footer-widget mb-4">
           <h2 class="ftco-heading-2">Have a Questions? You can contact us through</h2>
     ...
     <div class="row">
       <div class="col-md-12 text-center">
         ...
         <p>
           <span style="color: orange;font-size: 15px">&copy;<?php echo date('Y'); ?>-All Rights Reserved-powered by Ralph_Tech</span></p>
       </div>
     </div>
   </div>
 </footer>