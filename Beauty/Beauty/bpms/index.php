...
<html lang="en">
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/bg-2.jpg);" data-stellar-background-ratio="0.5">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Online Beauty Salon</span>
			            <h1 class="mb-4">Have Pretty Looks</h1>
			            <p class="mb-4">We offer beauty services that makes you glitter all day long and in your life time. Just check our services and get the pretty looks you wish.</p>
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Online Beauty Salon</span>
			            <h1 class="mb-4">Diamond Shine</h1>
			            <p class="mb-4">Shine bright like a diamond. Our highly advanced technology salon services will make you glitter as gold</p>
